...
def test():
    out_dir = Path("test_data/utide_analysis/ciopsw/nemo4/pa_nemo4_activate_sn_slp_sn_apr")
    if not out_dir.exists():
        out_dir.mkdir(parents=True, exist_ok=True)

    args = argparse.Namespace(
        **dict(
            inp_dir=Path("/home/jot000/.suites/IC5/ciops_w_pa_nemo4_activate_sn_slp_sn_apr/hub/ppp7/gridpt/anal/ciops_ssh/"),
            out_dir=out_dir,
            twl_nomvar="SSH",
            lat_nomvar="lat",
            lon_nomvar="lon",
